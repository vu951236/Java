...
@WebServlet("/PurchasecaServlet")
public class PurchasecaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT name, soluong, price FROM productsca WHERE id = ?";
            ...
            if (rs.next()) {
                ...
                if (quantity <= availableQuantity) {
                    ...
                    String updateSql = "UPDATE productsca SET soluong = soluong - ? WHERE id = ?";

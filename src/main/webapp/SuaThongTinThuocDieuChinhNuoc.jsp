...
<div class="main">
    ...
    <h2>Sửa thông tin Thuốc điều chỉnh nước</h2>
    <form action="SuaThuocNuocServlet" method="post" enctype="multipart/form-data">
        <label for="old_name_suatnc">Tên thuốc cũ:</label>
        <input type="text" id="old_name_suatnc" name="old_name" required><br><br>

        <label for="new_name_suatnc">Tên thuốc mới:</label>
        <input type="text" id="new_name_suatnc" name="new_name" ><br><br>

        <label for="ghichu_suatnc">Ghi chú:</label>
        <textarea id="ghichu_suatnc" name="ghichu" rows="4" cols="50" ></textarea><br><br>

        <label for="image_suatnc">Hình ảnh thuốc:</label>
        <input type="file" id="image_suatnc" name="image" accept="image/*"><br><br>

        <label for="hansudung_suatnc">Hạn sử dụng:</label>
        <input type="date" id="hansudung_suatnc" name="hansudung" ><br><br>

        <label for="soluong_suatnc">Số lượng:</label>
        <input type="number" id="soluong_suatnc" name="soluong" min="1" ><br><br>

        <label for="price_suatnc">Giá:</label>
        <input type="text" id="price_suatnc" name="price"><br><br>

        <input type="submit" value="Sửa Thuốc Điều Chỉnh Nước">
    </form>

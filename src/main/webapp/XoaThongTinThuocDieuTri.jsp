...
<div class="main">
  ...
  <h2>Xóa thông tin Thuốc điều trị Cá</h2>
  <form action="XoaThuocServlet" method="post">
    <label for="old_name_xoatca">Tên thuốc cần xóa:</label>
    <input type="text" id="old_name_xoatca" name="old_name" required><br><br>

    <input type="submit" value="Xóa Thuốc Điều Trị Cá">
  </form>

...
<div class="main">
  ...
  <h1>Xóa Thông Tin Hồ Cá Koi</h1>
  <form action="XoaHoServlet" method="post">
    <label for="ho_xoaname">Tên Hồ Cần Xóa:</label>
    <input type="text" id="ho_xoaname" name="ho_name" required>
    <br><br>

    <button type="submit">Xóa Thông Tin Hồ</button>
  </form>

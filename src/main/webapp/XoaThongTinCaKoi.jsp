...
<div class="main">
  ...
  <h2>Xóa thông tin cá Koi</h2>
  <form action="XoaKoiServlet" method="post">
    <label for="name_xoaca">Tên cá Koi cần xóa:</label>
    <input type="text" id="name_xoaca" name="name_ca" required><br><br>

            ...
            <%
                ...
                if (productId != null) {
                    ...
                    try {
                        ...
                        String sql = "SELECT * FROM thongtinho WHERE id = ?";
                        ...
                        if (rs.next()) {
                            ...
                            out.println("<div id='banner-wrapper'>"); // Thêm phần chứa toàn bộ các banner
                            for (int i = 1; i <= 4; i++) {
                            ...
                            out.println("<div><strong>Mô tả:</strong> " + rs.getString("mota") + "</div>");
                            out.println("<div><strong>Kích thước:</strong> " + rs.getString("kichthuoc") + "</div>");
                            out.println("<div><strong>Những cây phụ:</strong> " + rs.getString("nhungcayphu") + "</div>");
                            out.println("<div><strong>Loại cá phù hợp:</strong> " + rs.getString("loaicaphuhop") + "</div>");
                            out.println("</div>");
                        } else {

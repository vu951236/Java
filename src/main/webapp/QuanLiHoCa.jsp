...
<head>
    ...
    <script>
        function checkWaterParameters(event) {
            ...
            notificationDiv.style.display = 'block'; // Đặt display thành block để hiển thị thông báo
        }
        ...
        function calculateFood() {
            ...
            foodNotificationDiv.style.display = 'block'; // Đặt display thành block để hiển thị thông báo
        }
        ...
        function calculateSalt() {
            ...
            saltNotificationDiv.style.display = 'block'; // Đặt display thành block để hiển thị thông báo
        }

            ...
            <%
                ...
                if (productId != null) {
                    ...
                    try {
                        ...
                        String sql = "SELECT * FROM productsca WHERE id = ?";
                        ...
                        if (rs.next()) {
                            ...
                            // Thêm phần nhập số lượng mua và nút mua
                            out.println("<div class='purchase-section'>");
                            out.println("<form method='post' action='PurchasecaServlet'>"); // Truyền form tới servlet xử lý việc mua hàng
                            ...
                            out.println("<button type='submit' class='buy-button'>Mua ngay</button>");
                            out.println("</form>");
                            out.println("</div>");
                        } else {
